...
export function EffectsShowcasePage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-9rem)] overflow-hidden rounded-4xl border border-white/10 bg-[#02040a] text-slate-100 shadow-[0_30px_120px_rgba(0,0,0,0.45)]">
      
      <MagneticCursor disabled={!isDesktop} reducedMotion={prefersReducedMotion} />
      ...
      <section className="relative z-10 mx-auto flex min-h-[calc(100vh-9rem)] max-full flex-col justify-between px-6 py-10 md:px-10 md:py-14">
        <motion.div
        ...
        >
          ...
          <p className="mt-6 max-w-2xl text-sm leading-7 text-slate-300 md:text-base">
            Esta ruta existe para probar el sistema visual en aislamiento: particulas en canvas por capas,
            atraccion ligera por proximidad y cursor custom con API por data attributes.
          </p>
        </motion.div>
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[1.35fr_0.95fr]">
          ...
          >
            <p className="text-xs uppercase tracking-[0.32em] text-slate-400">Cursor API</p>
            <div className="mt-6 space-y-4">
              <div
                data-cursor="drag"
                className="rounded-[20px] border border-dashed border-white/15 bg-white/[0.03] p-5"
              >
                <p className="text-sm text-white">`data-cursor=&quot;drag&quot;`</p>
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  Muestra estado de arrastre con label interno y circulo ampliado.
                </p>
              </div>
              <div
                data-cursor="next"
              ...
              >
                <p className="text-sm text-white">
                  `data-cursor=&quot;next&quot; data-cursor-label=&quot;NEXT&quot;`
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-300">
                  Sobrescribe icono por texto corto sin agregar listeners por componente.
                </p>
              </div>
              <div
                data-cursor="play"
              ...
              >
                <p className="text-sm text-white">
                  `data-cursor=&quot;play&quot; data-cursor-icon=&quot;spark&quot;`
                </p>
                <p className="mt-2 text-sm leading-6 text-slate-300">
